...
#[cfg(feature = "sqlite")]
impl<T> ToSql<sql_types::Text, Sqlite> for T where T: Serialize {
    fn to_sql<W: Write>(
        &self,
...
#[cfg(feature = "sqlite")]
impl<T> FromSql<sql_types::Text, Sqlite> for T where T: Deserialize {
    fn from_sql(
...
#[cfg(feature = "postgres")]
impl<T> ToSql<sql_types::Text, Pg> for T where T: Serialize {
